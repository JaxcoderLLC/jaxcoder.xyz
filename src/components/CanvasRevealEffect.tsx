      ...
      <div className="py-20 flex flex-col lg:flex-row items-center justify-center bg-white dark:bg-black w-full gap-4 mx-auto px-8">
        ...
        <Card title="Nisha is Munni" icon={<AceternityIcon />}>
          <CanvasRevealEffect
            ...
            colors={[
              [0, 100, 0], // Dark green
              [0, 128, 0], // Another shade of dark green
            ]}
            dotSize={2}
          />
...
const Card = ({
  ...
  return (
    <div
      ...
      className="border border-white/[0.2] group/canvas-card flex items-center justify-center max-w-sm w-full mx-auto p-4 relative h-[30rem] relative bg-black text-white"
    >
