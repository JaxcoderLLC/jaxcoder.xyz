      ...
      <div className="bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 text-white py-20">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h1 className="text-4xl sm:text-5xl font-bold mb-6">
            Let&apos;s Discuss Your
            <span className="text-purple-400"> Enterprise Project</span>
          </h1>
      ...
      <div className="py-16">
        <div className="max-w-6xl mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-16">
            {/* Contact Form */}
            <div>
              <h2 className="text-3xl font-bold text-slate-900 mb-8">Strategy Discussion</h2>
              ...
              {submitStatus === 'success' && (
                <div className="mb-6 p-4 bg-green-50 border border-green-200 rounded-lg">
                  <div className="flex items-center">
                    ...
                    <p className="text-green-800 font-medium">Thank you! We&apos;ll respond within 24 hours to schedule your strategy call.</p>
                  </div>
                </div>
              )}
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid sm:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 border border-slate-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent disabled:bg-slate-50 disabled:cursor-not-allowed"
                    />
                  </div>
                  <div>
                ...
                <button
                  type="submit"
                  disabled={isSubmitting}
                  className="w-full bg-purple-600 hover:bg-purple-700 disabled:bg-purple-400 disabled:cursor-not-allowed text-white px-8 py-4 text-lg font-semibold rounded-lg transition-colors shadow-lg shadow-purple-600/30 flex items-center justify-center"
                >
                  {isSubmitting ? (
                    <>
            ...
            <div>
              ...
              <div className="space-y-8">
                <div className="bg-slate-50 p-6 rounded-xl">
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center">
                      ...
                      <a href="mailto:jromero@jaxlabs.xyz" className="text-slate-700 hover:text-purple-600">
                        jromero@jaxlabs.xyz
                      </a>
                    </div>
                  </div>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-slate-600 text-sm">Within 24 hours to schedule strategy call</p>
                      </div>
                    </div>
                    <div className="flex items-start">
                      <div className="w-8 h-8 bg-purple-100 rounded-full flex items-center justify-center mr-4 mt-1">
                      ...
                      <div>
                        <h4 className="font-semibold text-slate-900">Discovery Call</h4>
                        <p className="text-slate-600 text-sm">45-60 min deep dive into requirements</p>
                      </div>
                    </div>
                    <div className="flex items-start">
                      <div className="w-8 h-8 bg-purple-100 rounded-full flex items-center justify-center mr-4 mt-1">
                      ...
                      <div>
                        ...
                        <p className="text-slate-600 text-sm">Detailed technical architecture & timeline</p>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-yellow-50 p-6 rounded-xl border border-yellow-200">
                  <h3 className="text-xl font-bold text-yellow-900 mb-4">⚠️ Important Qualification</h3>
